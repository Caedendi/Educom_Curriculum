...
class ShopModel extends PageModel {
  ...
  public $valid = false;
  public $orderId = "";
  public $ratingStarFull = SERVER_ROOT . "img/star_thin_full.jpg";
  public $ratingStarEmpty = SERVER_ROOT . "img/star_thin_empty.jpg";
  public $ratingStarHalf = SERVER_ROOT . "img/star_thin_half.jpg";
  ...
  public function getRatingStar(string $type) {
    switch($type) {
      case 'Full': return $this->ratingStarFull;
      case 'Half': return $this->ratingStarHalf;
      default: return $this->ratingStarEmpty;
    }
  }
  ...
  public function getUserRating(int $id) {
    // TODO: 
    $rating = ShopDatabasemanager::findUserRating($id);
    empty($rating) ? $this->userRating = 0 : $this->userRating = $rating;    
  }
